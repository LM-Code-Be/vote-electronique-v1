...
$pageTitle = isset($pageTitle) ? (string)$pageTitle : 'Mot de passe';
/** @var bool $mustReset */
$mustReset = !empty($mustReset);
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-5 col-xl-4">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <h1 class="h5 mb-2 text-center">Changer le mot de passe</h1>
                            <?php if ($mustReset): ?>
                                <div class="alert alert-warning">Action requise : change ton mot de passe pour continuer.</div>
                            <?php endif; ?>
                            ...
                            <div class="text-center mt-3">
                                <a class="text-muted" href="<?=htmlspecialchars(app_url('/enterprise/profile.php'))?>">Retour profil</a>
                            </div>
                        </div>
                    </div>
                </div>
