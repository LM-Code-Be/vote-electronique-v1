...
$pageTitle = isset($pageTitle) ? (string)$pageTitle : 'Réinitialiser';
/** @var string $token */
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-5 col-xl-4">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <h1 class="h5 mb-3 text-center">Réinitialiser</h1>
                            ...
                            <div class="text-center mt-3">
                                <a class="text-muted" href="<?=htmlspecialchars(app_url('/enterprise/login.php'))?>">Connexion</a>
                            </div>
                        </div>
                    </div>
                </div>
